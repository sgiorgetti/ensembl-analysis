...
sub pipeline_analyses {
  ...
  my @analyses = (
    ...
    },
    {
      ...
      -module          => 'ensembl.hive.DBCopy',
      -max_retry_count => 0,
      -language        => 'python3',
      -parameters      => {
                            username => $self->o('username'),
                            endpoint => $self->o('copy_service_uri'),
                            src_host => $self->o('current_db_host') . ":" . $self->o('current_db_port'),
                            src_incl_db => $self->o('ensembl_db_name'),
                            tgt_host => $self->o('havana_db_host') . ":" . $self->o('havana_db_port'),
                            method   => 'post',
                            payload  => q/{
                              "user": "#username#",
                              "src_host": "#src_host#",
    ...
    },
    {
      ...
      -parameters => {
        ...
        extra_parameters => {
          ...
          hive_capacity => $self->o('meta_hive_capacity'),
